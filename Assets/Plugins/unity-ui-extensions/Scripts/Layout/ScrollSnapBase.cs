...
namespace UnityEngine.UI.Extensions
{
    public class ScrollSnapBase : MonoBehaviour, IBeginDragHandler, IDragHandler
    {
        ...
        internal void InitialiseChildObjectsFromScene()
        {
            ...
            {
                if(!ChildObjects.Contains(_screensContainer.transform.GetChild(i).gameObject))
                    ChildObjects.Add(_screensContainer.transform.GetChild(i).gameObject);
        ...
        internal void UpdateVisible()
        {
            ...
            if (!MaskArea || ChildObjects == null || ChildObjects.Count < 1 || _screensContainer.childCount < 1)
            {
                return;
            }
        ...
        private void OnValidate()
        {
            ...
            {
                var childCount = ChildObjects == null || ChildObjects.Count == 0 ? children : ChildObjects.Count;
